...
export default function Payment() {
  ...
  const handleConfirm = async () => {
    ...
    if (!listingId)
      return setError(
        "Listing information is missing. Please go back and try again.",
      );
    setError("");
    setLoading(true);
    try {
      ...
      // ── Notify host: payment record created ──────────────────────────────────
      ...
      <div style={s.page}>
        <div style={s.successWrap}>
          ...
          <p style={s.successSub}>
            Transfer the amount below to our bank account using your reference
            code as the transfer remark.
          </p>
          ...
          <div style={s.refCard}>
            ...
            <span style={s.refNote}>
              Use this as the bank transfer remark / description
            </span>
          </div>
          ...
          <div style={s.bankCard}>
            ...
            <div style={s.bankGrid}>
              <div style={s.bankRow}>
                ...
                <span style={s.bankVal}>{bankName}</span>
              </div>
              <div style={s.bankRow}>
                <span style={s.bankKey}>Account Name</span>
                <span style={s.bankVal}>{accountName}</span>
              </div>
              <div style={s.bankRow}>
                <span style={s.bankKey}>Account No.</span>
                <span style={s.bankVal}>{accountNumber}</span>
              </div>
              <div style={s.bankRow}>
                <span style={s.bankKey}>Branch</span>
                <span style={s.bankVal}>{branch}</span>
              </div>
              <div style={s.bankRow}>
                <span style={s.bankKey}>Amount</span>
                <span
                  style={{ ...s.bankVal, color: "#e07b00", fontWeight: 800 }}
                >
          ...
          <div style={s.summarySuccess}>
            <div style={s.summarySuccessRow}>
              ...
              <span style={s.bankVal}>
                {PLANS.find((p) => p.key === result.plan)?.label} ·{" "}
                {PLANS.find((p) => p.key === result.plan)?.duration}
              </span>
            </div>
            <div style={s.summarySuccessRow}>
            ...
            <div style={s.summarySuccessRow}>
              ...
              <span style={s.bankVal}>
                {new Date(result.newExpireDate).toLocaleDateString("en-GB", {
                  day: "numeric",
                  month: "long",
                  year: "numeric",
                })}
          ...
          <div style={s.nextStepBox}>
            ...
            <span>
              After transferring, go to <strong>My Payments</strong> and upload
              your receipt to complete verification.
            </span>
          </div>
  ...
  />
          ...
          <div style={s.bankPreview}>
            <div style={s.bankPreviewTitle}>
              <FaUniversity style={{ marginRight: 8 }} />
              Payment goes to
            </div>
            <div style={s.bankPreviewRow}>
              <span style={s.bankKey}>Bank</span>
              <span style={s.bankVal}>{bankName}</span>
            </div>
            <div style={s.bankPreviewRow}>
        ...
        <div style={s.rightCol}>
          ...
          <p style={s.planSub}>
            ...
            <strong>
              {listingType === "food" ? "food service" : "accommodation"}
            </strong>{" "}
            to stay published.
          </p>
            ...
            {PLANS.map((plan) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={s.planTop}>
                    <div>
                      <div style={{ ...s.planLabel, color: plan.color }}>
                        {plan.label}
                      </div>
                    ...
                    <div style={s.planRadio}>
                      {isSelected ? (
                        <FaCheckCircle
                          style={{ color: plan.color, fontSize: 20 }}
                        />
                      ) : (
                  ...
                  <div style={s.planPriceRow}>
                    ...
                    <span
                      style={{
                        ...s.planAmt,
                        color: isSelected ? plan.color : "#1a1a1a",
                      }}
                    >
                  ...
                  <div style={s.planMeta}>
                    <span style={s.planPerDay}>
                      ≈ LKR {Math.round(plan.amount / plan.daysAdded)}/day
                    </span>
            ...
            <div style={s.summaryBar}>
              <div style={s.summaryItem}>
                ...
                <span style={s.summaryVal}>
                  {selectedPlanData.label} · {selectedPlanData.duration}
                </span>
              </div>
              ...
              <div style={s.summaryItem}>
                ...
                <span style={s.summaryVal}>
                  {selectedPlanData.daysAdded} days
                </span>
              </div>
            </div>
          )}
          ...
          <p style={s.footNote}>
            No online payment required. You'll get a reference code to use for
            your bank transfer.
          </p>
        </div>
      </div>
